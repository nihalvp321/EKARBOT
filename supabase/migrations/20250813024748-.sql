-- Fix remaining critical security issues with correct table names
...
-- Customer table policies (correct case)
...
-- Activity table policies (correct case)
...
-- Lead table policies (correct case)
...
-- Enable RLS on tables that don't have it (correct case)
